...
class GlobeStats extends StatelessWidget {
  final GlobalSummaryModel summary;

  GlobeStats({required this.summary});
          ...
          child: Wrap(
            ...
            children: <Widget>[
              InfoCard(
                ...
                effectedNum: summary.totalConfirmed,
                press: () {},
              ),
              InfoCard(
                title: "Total Deaths",
                iconColor: Color(0xFFFF2D55),
                effectedNum: summary.totalDeaths,
                press: () {},
              ),
              InfoCard(
                title: "Total Recovered",
                iconColor: Color(0xFF50E3C2),
                effectedNum: summary.totalRecovered,
                press: () {},
              ),
              InfoCard(
                title: "New Cases",
                iconColor: Color(0xFF5856D6),
                effectedNum: summary.newConfirmed,
                press: () {
                  // Navigator.push(
                  //   context,
                  //   MaterialPageRoute(
